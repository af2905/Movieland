...
data class HomeMenuItem(
    ...
    val nameRes: Int
        get() = when (type) {
            HomeMenuItemType.LIKED -> R.string.home_menu_item_liked_title
            HomeMenuItemType.RECENTLY_VIEWED -> R.string.home_menu_item_recently_viewed_title
            HomeMenuItemType.SETTINGS -> R.string.home_menu_item_settings_title
        }
    ...
    companion object {
        ...
        private const val HOME_MENU_ITEM_SETTINGS_TYPE_ID = -12
    }
