...
import com.github.af2905.movieland.presentation.feature.home.di.DaggerTopRatedMovieComponent
...
class TopRatedMovieFragment :
    ...
    override fun onAttach(context: Context) {
        ...
        val topRatedMovieComponent = DaggerTopRatedMovieComponent.factory().create(appComponent)
